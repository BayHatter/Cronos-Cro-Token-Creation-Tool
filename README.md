# Cronos Token Creation Tool

A simple frontend tool to create tokens on the Cronos (CRO) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Cronos-Cro-Token-Creation-Tool.git
- And press deploy
- Congrats your Cronos Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Cronos-Cro-Token-Creation-Tool
- Upload into your Github repo.
- Edit the file public/config.json and insert your Cronos wallet address for receiving fees. Also set fee in CRO that you want to charge
